...
def _datetime_from_str(datetime_str: str) -> datetime:
    try:
...
class BaseHorsTests(unittest.TestCase):
    ...
    def test_january(self):
        ...
        self.assertEqual(10, date_from.day)
        self.assertEqual(1, date_from.month)
        self.assertEqual(2020, date_from.year)
    ...
    def test_time_period_before_day(self):
        ...
        self.assertEqual(17, date_from.hour)
        self.assertEqual(19, date_to.hour)
        self.assertEqual(14, date_from.day)
        self.assertEqual(14, date_to.day)
    ...
    def test_time_period_simple(self):
        ...
        self.assertEqual(10, date_from.hour)
        self.assertEqual(13, date_to.hour)
    ...
    def test_daytime(self):
        ...
        date: dict = result['dates'][0]
        date_from = _datetime_from_str(date['date_from'])
        self.assertEqual(str(DateTimeTokenType.FIXED), date['type'])
        self.assertEqual(13, date_from.hour)
    ...
    def test_nighttime(self):
        ...
        date_from = _datetime_from_str(date['date_from'])
        self.assertEqual(str(DateTimeTokenType.FIXED), date['type'])
        self.assertEqual(2, date_from.hour)

        date: dict = result['dates'][1]
        date_from = _datetime_from_str(date['date_from'])
        self.assertEqual(str(DateTimeTokenType.FIXED), date['type'])
        self.assertEqual(3, date_from.hour)

        date: dict = result['dates'][2]
        date_from = _datetime_from_str(date['date_from'])
        self.assertEqual(str(DateTimeTokenType.FIXED), date['type'])
        self.assertEqual(0, date_from.hour)
    ...
    def test_long_period(self):
        ...
        date_to = _datetime_from_str(date['date_to'])
        self.assertEqual(str(DateTimeTokenType.PERIOD), date['type'])
        self.assertEqual(2019, date_from.year)
        self.assertEqual(23, date_from.day)
        self.assertEqual(10, date_from.month)
        self.assertEqual(2, date_to.day)
        self.assertEqual(12, date_to.month)
        self.assertEqual(9, date_to.hour)
        self.assertEqual(15, date_to.minute)
    ...
    def test_collapse_complex(self):
        ...
        self.assertEqual(2019, date_from.year)
        self.assertEqual(14, date_from.day)
        self.assertEqual(21, date_from.hour)

        date: dict = result['dates'][1]
        date_from = _datetime_from_str(date['date_from'])
        self.assertEqual(14, date_from.day)
        self.assertEqual(22, date_from.hour)
    ...
    def test_multiple_simple(self):
        ...
        date_from = _datetime_from_str(date['date_from'])
        self.assertEqual(2019, date_from.year)
        self.assertEqual(11, date_from.day)
        self.assertEqual(6, date_from.hour)
        self.assertEqual(30, date_from.minute)
    ...
    def test_collapse_direction(self):
        ...
        for s in strings:
            ...
            date_from = _datetime_from_str(date['date_from'])
            self.assertEqual(2019, date_from.year)
            self.assertEqual(4, date_from.day)
            self.assertEqual(11, date_from.month)
    ...
    def test_weekday(self):
        ...
        date_from = _datetime_from_str(date['date_from'])
        self.assertEqual(2019, date_from.year)
        self.assertEqual(5, date_from.day)
        self.assertEqual(11, date_from.month)
        ...
        date_from = _datetime_from_str(date['date_from'])
        self.assertEqual(2019, date_from.year)
        self.assertEqual(12, date_from.day)
        self.assertEqual(11, date_from.month)
    ...
    def test_time_after_day(self):
        ...
        self.assertEqual(str(DateTimeTokenType.FIXED), date['type'])
        self.assertEqual(True, date['has_time'])
        self.assertEqual(16, date_from.hour)
        self.assertEqual(10, date_from.day)
    ...
    def test_time_period(self):
        ...
        date_to = _datetime_from_str(date['date_to'])
        self.assertEqual(True, date['has_time'])
        self.assertEqual(9, date_from.hour)
        self.assertEqual(12, date_from.day)
        self.assertEqual(9, date_from.month)
        self.assertEqual(18, date_to.hour)
        self.assertEqual(12, date_to.day)
        self.assertEqual(9, date_to.month)
        self.assertEqual(2019, date_from.year)
        self.assertEqual(2019, date_to.year)
    ...
    def test_complex_period(self):
        ...
        self.assertEqual(18, date_from.day)
        self.assertEqual(9, date_from.month)
        self.assertEqual(12, date_to.hour)
        self.assertEqual(20, date_to.day)
        self.assertEqual(9, date_to.month)
        self.assertEqual(2019, date_from.year)
        self.assertEqual(2019, date_to.year)
    ...
    def test_fix_period(self):
        ...
        self.assertEqual(str(DateTimeTokenType.PERIOD), date['type'])
        self.assertEqual(14, date_from.day)
        self.assertEqual(15, date_to.day)
    ...
    def test_holidays(self):
        ...
        date_to = _datetime_from_str(date['date_to'])
        self.assertEqual(str(DateTimeTokenType.PERIOD), date['type'])
        self.assertEqual(7, date_from.day)
        self.assertEqual(8, date_to.day)
